      ...
      <div className="grid lg:grid-cols-2 gap-6 my-12">
        ...
        <article className="space-y-2">
          ...
          <p className="line-clamp-3">
            ...
            hic expedita dolore laboriosam illum repellendus consectetur!
            Tenetur unde, sint voluptatibus libero tempore iure id perspiciatis
            vel cumque facere fugit eius expedita, consectetur animi eligendi
            fuga reiciendis itaque voluptatum odio quia hic laudantium! Suscipit
            atque accusamus eaque officiis aliquam dolores eius.
          </p>
          <Link
            href=""
